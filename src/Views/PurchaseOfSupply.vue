...
export default {
  ...
  data() {
    return {
      headers: [
        ...
        {text: "Название сырья", value: "supply", sort: true, align: "center"},
  ...
  methods: {
    ...
    deleteConfirm() {
      api.post("/api/purchase-of-supply/delete/" + this.deletedItem)
          .then(
    ...
    savePurchaseOfSupply() {
      if (this.isCreate) {
        api.post("/api/purchase-of-supply/add", this.item)
            .then(r => {
              this.message = r.data
            }).finally(
            () => {
        ...
        api.post("/api/purchase-of-supply/update", this.item)
            .then(r => {
              this.message = r.data
            }).finally(
            () => {
    ...
    getItems() {
      api.get("/api/purchase-of-supply/all").then(
          response => {
