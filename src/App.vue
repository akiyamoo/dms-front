<template>
  <v-app>
    ...
    >
      ...
      <v-spacer></v-spacer>
      <v-btn @click="$router.push('/employee')" small>
        Сотрудники
      </v-btn>
      <v-spacer></v-spacer>
      ...
      <v-spacer></v-spacer>
      <v-btn @click="$router.push('/ingredient')" small>
        Ингредиенты
      </v-btn>
      <v-spacer></v-spacer>
      ...
      <v-spacer></v-spacer>
      <v-btn @click="$router.push('/product')" small>
        Готовая продукция
      </v-btn>
      <v-spacer></v-spacer>
      <v-btn :disabled="false" @click="$router.push('/production-of-product')" small>
      ...
      <v-spacer></v-spacer>
      <v-btn :disabled="false" @click="$router.push('/salary')" small>
        Зарплата
      </v-btn>
      <v-spacer></v-spacer>
    </v-app-bar>
